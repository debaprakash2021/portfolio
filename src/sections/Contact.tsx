        ...
        <div className="contact-grid grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div className="contact-card p-8 rounded-2xl border border-white/10 bg-white/[0.02]">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-lime text-black font-medium rounded-xl hover:shadow-glow-lg transition-all duration-300 hover:scale-[1.02] flex items-center justify-center gap-2"
              >
                <Send size={18} />
                Send Message
              </button>
